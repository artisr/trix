 ...
 */
var hasRequiredRangyCore;
function requireRangyCore() {
  if (hasRequiredRangyCore) return rangyCore.exports;
  hasRequiredRangyCore = 1;
  ...
  return rangyCore.exports;
}

var rangyCoreExports = requireRangyCore();
...
(function (module, exports) {
  ...
  (function (factory, root) {
    if (typeof undefined == "function" && undefined.amd) {
      ...
      // Node/CommonJS style
      module.exports = factory(requireRangyCore());
    } else {
...
const moveCursor = async options => {
  ...
  const move = async () => {
    ...
    if (triggerEvent(document.activeElement, "keydown", {
      ...
      const selection = rangyCoreExports.getSelection();
...
const selectAll = async () => {
  rangyCoreExports.getSelection().selectAllChildren(document.activeElement);
  selectionChangeObserver.update();
  await nextFrame();
};
...
const selectionIsCollapsed = () => rangyCoreExports.getSelection().isCollapsed;
